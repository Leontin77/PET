...
export const Contacts = () => {
  ...
  const onSubmit = (e: any) => {
    ...
    emailjs
      .send("service_1ivsytk", "template_lir20jj", templateParams)
      .then((response) => {
        setPopUpOpen(true);
      ...
      <div className="contactsWrapper-content">
          ...
          {width > 1024 ? (
            <div className="formsInputs-name">
              <div>
                ...
                <input
                  className="formsInputs-name-input"
                  type="text"
        ...
        <div className="aboutUs">
          ...
          <div className="aboutUs-content">
            ...
            <a
              href="tel:+38-066-090-14-12"
              className="aboutUs-content__description"
            >
              +38-(044)-33-44-318
            </a>
          </div>
          <div className="aboutUs-content">
            ...
            <div className="aboutUs-content__description">М. Київ, Україна</div>
          </div>
          <div className="aboutUs-content">
            <div className="aboutUs-content__title">Наша пошта</div>
            <a
              href="mailto:info@p8tech.com.ua"
              className="aboutUs-content__description"
            >
              info@p8tech.com.ua
            </a>
          ...
          <div className="aboutUs-content">
            ...
            <a
              href="http://instagram.com/_u/p8t.com.ua"
              className="aboutUs-content__description"
            >
